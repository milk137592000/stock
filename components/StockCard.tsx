        ...
        <div className={`p-4 ${categoryColor}`}>
          ...
          <div className="flex justify-between items-center">
            ...
            <span className="text-xs text-white/80">
              現價: {stock.currentPrice > 0 ? stock.currentPrice.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }) : 'N/A'} NTD
            </span>
          </div>
        </div>
        <div className="p-4 space-y-3">
          {stock.currentHoldingShares !== undefined && ( // Show even if 0 for context
            <div>
